#Resources
$resourceGroupName = "RESOURCEGROUP" # Resource group of Linux servers
$location = "uk south"
$region = "uksouth"
...
write-Host -ForegroundColor Cyan "Updating VM..."
$vm3nic = Get-AzureRmNetworkInterface -ResourceGroupName $resourceGroupName -Name "VM3_NIC1"
$vm3nic.NetworkSecurityGroup = $nsg
Set-AzureRmNetworkInterface -NetworkInterface $vm3nic