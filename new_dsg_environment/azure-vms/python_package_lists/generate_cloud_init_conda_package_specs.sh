...
# Insert Anaconda meta packages
echo "  # Anaconda meta packages" >> $OUTFILE
echo "  - export ANACONDAMETAPACKAGES = \"anaconda-client anaconda-navigator anaconda-project conda conda-build conda-env\"" >> $OUTFILE
echo ""  >> $OUTFILE


echo "  # Consolidate package lists for each Python version" >> $OUTFILE
echo "  - export PYTHON27PACKAGES=\"\$PYALLREQUESTEDPACKAGES \$PY27REQUESTEDPACKAGES \$PYALLANACONDAPACKAGES \$PY27ANACONDAPACKAGES \$ANACONDAMETAPACKAGES\"" >> $OUTFILE
echo "  - export PYTHON35PACKAGES=\"\$PYALLREQUESTEDPACKAGES \$PY35REQUESTEDPACKAGES \$PYALLANACONDAPACKAGES \$PY35ANACONDAPACKAGES \$ANACONDAMETAPACKAGES\"" >> $OUTFILE
echo "  - export PYTHON36PACKAGES=\"\$PYALLREQUESTEDPACKAGES \$PY36REQUESTEDPACKAGES \$PYALLANACONDAPACKAGES \$PY36ANACONDAPACKAGES \$ANACONDAMETAPACKAGES\"" >> $OUTFILE
