...
$webclientScript | Out-File $webclientScriptLocalFilePath
$webclientScriptName = "Install_Webclient.ps1"
...
$remoteFilePaths = $deployScriptName, $webclientScriptName ;

$pipeSeparatedFilePaths = $remoteFilePaths -join "|"
