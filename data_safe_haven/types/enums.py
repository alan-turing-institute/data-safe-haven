...
class NetworkingPriorities(int, Enum):
    ...
    INTERNAL_SRE_BACKUP = 1710
    INTERNAL_SRE_CLAMAV_MIRROR = 1720
    ...
    INTERNAL_SRE_GUACAMOLE_CONTAINERS_SUPPORT = 1910
    INTERNAL_SRE_IDENTITY_CONTAINERS = 1920
    INTERNAL_SRE_MONITORING_TOOLS = 2000
    INTERNAL_SRE_USER_SERVICES_CONTAINERS = 2100
    INTERNAL_SRE_USER_SERVICES_CONTAINERS_SUPPORT = 2110
    INTERNAL_SRE_USER_SERVICES_DATABASES = 2120
    INTERNAL_SRE_USER_SERVICES_SOFTWARE_REPOSITORIES = 2130
