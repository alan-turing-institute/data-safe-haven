    ...
    def run(self) -> None:
        ...
        data = SREDataComponent(
            ...
            SREDataProps(
                ...
                subnet_configuration_data=networking.subnet_configuration_data,
        ...
        remote_desktop = SRERemoteDesktopComponent(
            ...
            SRERemoteDesktopProps(
                ...
                storage_account_key=data.storage_account_configuration_data_key,
                storage_account_name=data.storage_account_configuration_data_name,
