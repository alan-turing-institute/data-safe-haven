...
class NetworkingPriorities(int, Enum):
    ...
    INTERNAL_SRE_GUACAMOLE_REMOTE_DESKTOP = 1600
    INTERNAL_SRE_GUACAMOLE_REMOTE_DESKTOP_SUPPORT = 1650
    INTERNAL_SRE_PRIVATE_DATA = 1700
    INTERNAL_SRE_USER_SERVICES_CONTAINERS = 1800
    INTERNAL_SRE_USER_SERVICES_CONTAINERS_SUPPORT = 1850
    INTERNAL_SRE_USER_SERVICES_DATABASES = 1900
