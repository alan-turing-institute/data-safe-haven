...
_all_releases = sorted(t.name for t in repo.tags)
_earliest_supported_release_idx = _all_releases.index(earliest_supported_release)
_all_supported_releases = _all_releases[_earliest_supported_release_idx:]
supported_versions = [development_branch] + _all_supported_releases
_latest_supported_release = _all_supported_releases[-1]
