...
if [ "$METHOD" == "npm" ]; then
    ...
    pretty-md-pdf -i $INFILE -o $FILESTEM.pdf -c markdown2pdf.json
    ...
    pandoc $INFILE -f gfm --pdf-engine=xelatex -o $FILESTEM.pdf -V geometry:margin=1.2in -V mainfont:Symbola
