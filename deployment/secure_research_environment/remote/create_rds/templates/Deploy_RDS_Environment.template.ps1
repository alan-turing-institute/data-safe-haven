...
New-RDRemoteApp -Alias "mstsc (1)" -DisplayName "DSVM Main (Desktop)" -FilePath "C:\Windows\system32\mstsc.exe" -ShowInWebAccess 1 -CommandLineSetting Require -RequiredCommandLine "-v $dsvmInitialIpAddress" -CollectionName "Remote Applications" -ConnectionBroker $rdsGatewayVmFqdn
New-RDRemoteApp -Alias "putty (1)" -DisplayName "DSVM Main (SSH)" -FilePath "C:\Program Files\PuTTY\putty.exe" -ShowInWebAccess 1 -CommandLineSetting Require -RequiredCommandLine "-ssh $dsvmInitialIpAddress" -CollectionName "Remote Applications" -ConnectionBroker $rdsGatewayVmFqdn
...
New-RDRemoteApp -Alias "chrome (1)" -DisplayName "GitLab" -FilePath "C:\Program Files (x86)\Google\Chrome\Application\chrome.exe" -ShowInWebAccess 1 -CommandLineSetting Require -RequiredCommandLine "http://${gitlabIpAddress}" -CollectionName "Remote Applications" -ConnectionBroker $rdsGatewayVmFqdn
New-RDRemoteApp -Alias "chrome (2)" -DisplayName "HackMD" -FilePath "C:\Program Files (x86)\Google\Chrome\Application\chrome.exe" -ShowInWebAccess 1 -CommandLineSetting Require -RequiredCommandLine "http://${hackmdIpAddress}:3000" -CollectionName "Remote Applications" -ConnectionBroker $rdsGatewayVmFqdn
