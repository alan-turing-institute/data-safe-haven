...
$params = @{
    ...
    shmSystemAdministratorSgDescription = "`"$($config.shm.domain.securityGroups.serverAdmins.description)`""
    systemAdministratorSgName = "`"$($config.sre.domain.securityGroups.systemAdministrators.name)`""
    systemAdministratorSgDescription = "`"$($config.sre.domain.securityGroups.systemAdministrators.description)`""
