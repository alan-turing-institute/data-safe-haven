...
$rdsSh3AdminPassword = Resolve-KeyVaultSecret -VaultName $config.sre.keyVault.name -SecretName $config.sre.rds.sessionHost3.adminPasswordSecretName -DefaultLength 20
...
$params = @{
    ...
    RDS_Gateway_Data3_Disk_Size_GB           = [int]$config.sre.rds.gateway.disks.data3.sizeGb
    RDS_Gateway_Data3_Disk_Type              = $config.sre.rds.gateway.disks.data3.type
    ...
    RDS_Session_Host_Review_Admin_Password   = (ConvertTo-SecureString $rdsSh3AdminPassword -AsPlainText -Force)
    ...
    RDS_Session_Host_Review_Os_Disk_Size_GB  = [int]$config.sre.rds.sessionHost3.disks.os.sizeGb
    RDS_Session_Host_Review_Os_Disk_Type     = $config.sre.rds.sessionHost3.disks.os.type
...
Add-VmToNSG -VMName $config.sre.rds.sessionHost3.vmName -VmResourceGroupName $config.sre.rds.rg -NSGName $config.sre.rds.sessionHost3.nsg -NsgResourceGroupName $config.sre.network.vnet.rg
