...
$params = @{
    ...
    RDS_Gateway_Data1_Disk_Size_GB = $config.rds.gateway.disks.data1.sizeGb
    RDS_Gateway_Data1_Disk_Type = $config.rds.gateway.disks.data1.type
    RDS_Gateway_Data2_Disk_Size_GB = $config.rds.gateway.disks.data2.sizeGb
    ...
    RDS_Gateway_Os_Disk_Size_GB = $config.rds.gateway.disks.os.sizeGb
    ...
    RDS_Session_Host_Apps_Os_Disk_Size_GB = $config.rds.sessionHost1.disks.os.sizeGb
    ...
    RDS_Session_Host_Desktop_Os_Disk_Size_GB = $config.rds.sessionHost2.disks.os.sizeGb
