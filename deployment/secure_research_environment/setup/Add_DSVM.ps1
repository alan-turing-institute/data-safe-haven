...
$dsvmIngressSasToken = Resolve-KeyVaultSecret -VaultName $config.sre.keyVault.name -SecretName $config.sre.storage.datastorage.containers.ingress.researcherPolicy.sasSecretName
