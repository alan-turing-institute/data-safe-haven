...
$params = @{
    ...
    GitLab_Data_Disk_Size_GB = $config.sre.webapps.gitlab.disks.data.sizeGb
    GitLab_Data_Disk_Type = $config.sre.webapps.gitlab.disks.data.type
    GitLab_Os_Disk_Size_GB = $config.sre.webapps.gitlab.disks.os.sizeGb
    ...
    HackMD_Os_Disk_Size_GB = $config.sre.webapps.hackmd.disks.os.sizeGb
