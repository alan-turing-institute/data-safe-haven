...
$cloudInitTemplate = $cloudInitTemplate.Replace("# === AUTOGENERATED JULIA PACKAGES GO HERE ===", $juliaPackageText)
...
$cloudInitTemplate = $cloudInitTemplate.Replace("# === AUTOGENERATED ANACONDA PACKAGES GO HERE ===", $pythonPackages)
...
$cloudInitTemplate = $cloudInitTemplate.Replace("# === AUTOGENERATED R PACKAGES GO HERE ===", $rPackages)
